...
sudo apt install fontconfig fonts-noto-cjk fonts-noto-cjk-extra fonts-wqy-zenhei fonts-wqy-microhei xfonts-intl-chinese xfonts-intl-chinese-big xfonts-wqy fonts-noto-color-emoji fonts-emojione # For GUI

# Just Ubuntu
sudo apt install language-pack-zh-hans
sudo apt install $(check-language-support) # For GUI
```
